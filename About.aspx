<%@ Page Language="C#" AutoEventWireup="true" CodeFile="About.html.cs" Inherits="About" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
          <title>About us - ASPEN ENGINEERING</title>
          <meta charset="utf-8"/>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                ...
                <p class="description">We believe that Personnel, Process and Environmental safety are the most crucial elements for our business.</p>
              </div>
                <!--LEED consultancy-->
              <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                ...
                <p class="description">
                    ASPEN employees to take personal responsibility to follow Aspen code of
                    ethics to standardize their behavior and for the decisions they make every day.</br>
                    Honesty and Integrity must always be at the core of those decisions.
                </p>
              </div>
              <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                ...
                <p class="description">
                    Respect among employees on a horizontal level and between superiors and
